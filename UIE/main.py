    ...
    for epoch in epoch_iterator:
        ...
        for batch in train_data_iterator:
            ...
            if global_step % args.valid_steps == 0:
                ...
                swanlab.log({"presicon": precision,"F1":f1,"recall":recall})
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--train_path", default='./data/train.txt', type=str, help="The path of train set.")
    parser.add_argument("-d", "--dev_path", default='./data/dev.txt', type=str, help="The path of dev set.")
    parser.add_argument("-s", "--save_dir", default='./checkpoint/mini', type=str,
    ...
    parser.add_argument("-m", "--model", default="uie_mini_pytorch", type=str,
    ...
    swanlab.init(
        # 设置实验名称
        experiment_name="uie_finetune",
        # 设置实验介绍
        description="命名实体识别微调实验",
        # 设置日志存放地址
        logdir= "./logs",
        # 记录跟踪的超参数和运行元数据
        config=args)
